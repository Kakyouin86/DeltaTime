...
Shader "WeatherMaker/WeatherMakerParticleShader"
{
    Properties
	{
		...
		_WeatherMakerDitherLevel ("Dither Level", Range(0, 1)) = 0.002
    }
    ...
    SubShader
	{
        ...
        Pass
		{
			...
			{       
				...
				fixed4 color = tex2D(_MainTex, i.uv_MainTex) * i.color * CalculateVertexColor(i.viewPos);
				...
				// dither
				ApplyDither(color.rgb, i.projPos.xy, fixed3(0.06711056, 0.00583715, 52.9829189), _WeatherMakerDitherLevel * (1.0 / max(0.001, color.a)));
