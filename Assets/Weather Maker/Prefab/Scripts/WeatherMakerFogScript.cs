...
namespace DigitalRuby.WeatherMaker
{
    public abstract class WeatherMakerFogScript : MonoBehaviour
    {
        ...
        protected virtual void UpdateMaterial()
        {
            ...
            FogMaterial.SetFloat("_WeatherMakerDitherLevel", DitherLevel);
            ...
            if (Sun != null)
            {
                FogMaterial.SetVector("_WeatherMakerSunDirection", -Sun.transform.forward);
                Vector4 sunColor = new Vector4(Sun.color.r, Sun.color.g, Sun.color.b, Sun.intensity);
                FogMaterial.SetVector("_WeatherMakerSunColor", sunColor);
            }
        }
